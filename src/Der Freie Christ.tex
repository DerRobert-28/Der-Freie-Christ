...
\date{\textit{Letzte \"Anderung: 8. Oktober 2023}}
...
\begin{document}
	...
	\subsection{Ganz allgemein gesagt}
		...
		zu behaupten,
		inwiefern man f\"ur irgendwelche S\"unden bestraft wird.
		Ich glaube eher,
		dass man sich m\"oglicherweise schon f\"ur seine Taten rechtfertigen darf.
		Ich sage nicht,
		dass man \q{bestraft} wird,
	...
	\subsection{Wir sind alle S\"under}
		...
		\begin{itemize}
			...
			\item	Hast du schonmal jemanden beleidigt oder gekr\"ankt?
					Hast du bspw. im Stra{\ss}enverkehr jemandem \q{\textit{Idiot}} hinterhergerufen,
			...
			\item	Hast du schon gelogen?
					...
					\q{\textit{Wie geht es dir?}}
					Sagst du einfach nur \q{\textit{Gut.}} aus H\"oflichkeit,
	...
	\subsection{Zusammenfassung}
		...
		ob wir mit {\Ihm} leben oder ohne.
