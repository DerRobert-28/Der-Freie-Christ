...
\begin{document}
	...
	\subsection{Das Glaubensbekenntnis}
		...
		\begin{itemize}[nosep]
			...
			\item[]	den {\Vater},
					den {\Allmaechtigen},
			\item[]	den {\Schoepfer} des {\Himmels} und der Erde.
			\item	Ich glaube an {\Jesus} {\Christus},
			\item[]	{\Seinen} eingebohrenen {\Sohn},
					meinen {\Herrn},
			\item[]	empfangen durch den {\Heiligen} {\Geist},
			\item[]	geboren von der Jungfrau Maria,
			\item[]	gelitten unter Pontius Pilatus,
			\item[]	gekreuzigt,
					gestorben und begraben,
			\item[]	hinabgestiegen in das Reich des Todes,
			\item[]	am Dritten Tage auferstanden von den Toten,
			\item[]	aufgefahren in den {\Himmel};
			\item[]	{\Er} sitzt zur Rechten {\Gottes},
			\item[]	des {\Allmaechtigen} {\Vaters};
			\item[]	von dort wird {\Er} kommen,
			\item[]	zu richten die Lebenden und die Toten.
			\item	Ich glaube an den {\Heiligen} {\Geist},
			\item[]	an die Vergebung der S\"unden,
			\item[]	an die Auferstehung der Toten,
			\item[]	und das Ewige Leben.
			\item	Amen!
		\end{itemize}
