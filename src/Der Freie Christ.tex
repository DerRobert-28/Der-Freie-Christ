...
\date{\textit{Letzte \"Anderung: 24. März 2024}}
...
\begin{document}
	...
	\subsection{{\Gott} ist ...}
		\begin{itemize}[nosep]
			...
			\item {\Er} ist der himmlische {\Vater}. \textit{(Matth\"aus 6, 14)}			
			...
			\item {\Er} ist (m)ein Zeuge. \textit{(Philipper 1, 8)}
	...
	\subsubsection{Weitere T\"otungsarten}
		...
		und zwar m\"oglicherweise Bakterien oder Viren.
		...
		m\"ussen im Prinzip die Bakterien (oder Viren) sterben.
