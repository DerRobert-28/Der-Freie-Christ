...
\date{\textit{Letzte \"Anderung: 19. Oktober 2023}}
...
\begin{document}
	...
	\subsubsection{(Be-)Schw\"oren}
		...
		\\
		Vielleicht kann man das ganze auch so interpretieren oder \"ubersetzen,
		...
		Und mit Magie und Zauberei meine ich nicht die aus Film und Fernsehen,
		oder irgendwelche Kartentricks.
		Diese finde ich selbst teilweise unterhaltsam.
	...
	\subsubsection{(Ver-)Fluchen}
		...
		Gleichzeitig verst\"o{\ss}t du dabei gegen das zweite Gebot {\Gottes},
