...
\begin{document}
	...
	\subsection{Comparison}
		...
		\q{You will recognize {\God} as {\Lord} and deliverer \textit{(liberator)} from Egypt.}
		And the sixth one as parallel connection is:
		\q{You will not kill or murder.}
		Of course,
		...
		\\
		The 10 Offers are also cabable to be compared to each other,
