...
\begin{document}
	...
	\subsection{The Creed of Belief}
		...
		\begin{itemize}[nosep]
			...
			\item[]	the {\Father},
					the {\Allmighty},
			\item[]	the {\Creator} of {\Heaven} and Earth.
			\item	I believe in {\Jesus} {\Christ},
			\item[]	{\His} only {\Son},
					my {\Lord};
			\item[]	he was conceived by the {\Holy} {\Spirit},
			\item[]	and born by the virgin Mary;
			\item[]	{\He} suffered under Pontius Pilate;
			\item[]	{\He} was crucified, {\He} died and was buried,
			\item[]	and descended to the Realm of Death;
			\item[]	on the Third Day {\He} rose again,
			\item[]	{\He} ascended into {\Heaven};
			\item[]	{\He} is seated to the right hand of the {\Father};
			\item[]	{\He} will come again,
			\item[]	to judge the living and the dead.
			\item	I believe in the {\Holy} {\Spirit},
			\item[] the forgiveness of sins,
			\item[] the resurrection of the body,
			\item[] and in everlasting life.
			\item	Amen!
		\end{itemize}
